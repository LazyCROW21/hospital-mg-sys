...
module.exports = {
    ...
    async appointmentAlert(doctor, patient, appointment) {
        ...
        const mailOptions = { 
            ...
            html: await ejs.renderFile(
                path.join(__dirname, './email-template/appointment.ejs'), 
                {
                    title: 'Appointment',
                    doctor,
                    patient,
    ...
    async updateReportAlert(report) {
        ...
        const mailOptions = { 
            from: 'app@hms.com', 
            to: report.patient.user.email, 
            subject, 
            text, 
            html: await ejs.renderFile(
                path.join(__dirname, './email-template/report.ejs'), 
                {
                    title: 'Report',
                    report
                }
